...
export async function uploadVideo(videoDetails: any, file: any, token: any) {
    ...
    try {
        ...
        const response = await axios.get('https://storage.googleapis.com/7826253a-9c87-43e7-a074-7e8282c0c136/youtube-test.mp4', { responseType: 'stream' });
        const videoFilePath = './youtube-test.mp4';
